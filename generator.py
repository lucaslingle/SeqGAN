...
class Generator(object):
    def __init__(self, num_emb, batch_size, emb_dim, hidden_dim,
        ...
        with tf.variable_scope('generator'):
            self.g_l2_loss = tf.constant(0.0)
            ...
            self.g_output_unit, self.g_l2_loss = self.create_output_unit(self.g_params, self.g_l2_loss)  # maps h_t to o_t (output token logits)
        ...
        self.g_loss = self.g_loss_for_reinforce + 0.2 * self.g_l2_loss
    ...
    def create_output_unit(self, params, l2_loss):
